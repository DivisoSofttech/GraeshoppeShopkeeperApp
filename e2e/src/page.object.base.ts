...
export class PageObjectBase {
  ...
  waitUntilInvisible() {
   return browser.wait(ExpectedConditions.invisibilityOf(this.rootElement()), 30000);
  }

  waitUntilPresent() {
  return  browser.wait(ExpectedConditions.presenceOf(this.rootElement()), 30000);
  }
  ...
  async waitUntilVisible() {
    return browser.wait(ExpectedConditions.visibilityOf(this.rootElement()), 30000);
  }
